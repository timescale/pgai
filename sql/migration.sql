...
$migration_body$;
begin
    select * into _migration from @extschema@.migration where "name" operator(pg_catalog.=) _migration_name;
    ...
    execute _sql;
    insert into @extschema@.migration ("name", body, applied_at_version)
