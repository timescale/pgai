...
create or replace function @extschema@.openai_tokenize(_model text, _text text) returns int[]
as $func$
ADD-PYTHON-LIB-DIR
import tiktoken
...
-- https://github.com/openai/tiktoken/blob/main/README.md
create or replace function @extschema@.openai_detokenize(_model text, _tokens int[]) returns text
as $func$
ADD-PYTHON-LIB-DIR
import tiktoken
encoding = tiktoken.encoding_for_model(_model)
...
create or replace function @extschema@.openai_list_models(_api_key text default null)
returns table
( id text
, created timestamptz
, owned_by text
...
create or replace function @extschema@.openai_embed
( _model text
, _input text
...
create or replace function @extschema@.openai_chat_complete
( _model text
, _messages jsonb
, _api_key text default null
...
create or replace function @extschema@.openai_moderate
( _model text
, _input text
, _api_key text default null
) returns jsonb
