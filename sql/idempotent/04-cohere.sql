...
create or replace function @extschema@.cohere_list_models
...
create or replace function @extschema@.cohere_tokenize(_model text, _text text, _api_key text default null) returns int[]
as $func$
ADD-PYTHON-LIB-DIR
import ai.cohere
client = ai.cohere.make_client(plpy, _api_key)
...
create or replace function @extschema@.cohere_detokenize(_model text, _tokens int[], _api_key text default null) returns text
as $func$
ADD-PYTHON-LIB-DIR
import ai.cohere
client = ai.cohere.make_client(plpy, _api_key)
...
create or replace function @extschema@.cohere_embed
( _model text
, _input text
, _api_key text default null
...
create or replace function @extschema@.cohere_classify
( _model text
, _inputs text[]
, _api_key text default null
...
-- https://docs.cohere.com/reference/classify
create or replace function @extschema@.cohere_classify_simple
( _model text
, _inputs text[]
, _api_key text default null
, _examples jsonb default null
...
create or replace function @extschema@.cohere_rerank
( _model text
, _query text
, _documents jsonb
, _api_key text default null
...
-- https://docs.cohere.com/reference/rerank
create or replace function @extschema@.cohere_rerank_simple
( _model text
, _query text
, _documents jsonb
, _api_key text default null
...
create or replace function @extschema@.cohere_chat_complete
( _model text
, _message text
, _api_key text default null
