...
--
create or replace function @extschema@.ollama_list_models(_host text default null)
returns table
( "name" text
, model text
, size bigint
...
create or replace function @extschema@.ollama_ps(_host text default null)
returns table
( "name" text
, model text
, size bigint
...
create or replace function @extschema@.ollama_embed
( _model text
, _input text
...
create or replace function @extschema@.ollama_generate
( _model text
, _prompt text
, _host text default null
...
create or replace function @extschema@.ollama_chat_complete
( _model text
, _messages jsonb
, _host text default null
, _keep_alive float8 default null
