...
( id pg_catalog.int8 not null primary key generated by default as identity 
...
, relevancy_rank pg_catalog.int8 not null default 0
...
perform pg_catalog.pg_extension_config_dump('ai.semantic_catalog_obj_id_seq'::pg_catalog.regclass, '');
create index on ai.semantic_catalog_obj (relevancy_rank desc) where objsubid = 0;
