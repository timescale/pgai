...
create table ai.semantic_catalog_embeddings
( id pg_catalog.int4 not null primary key generated by default as identity
, embedding_name pg_catalog.text not null unique
, obj_vectorizer_id pg_catalog.int4
, sql_vectorizer_id pg_catalog.int4
);
perform pg_catalog.pg_extension_config_dump('ai.semantic_catalog_embeddings'::pg_catalog.regclass, '');
perform pg_catalog.pg_extension_config_dump('ai.ai.semantic_catalog_embeddings_id_seq'::pg_catalog.regclass, '');
...
perform pg_catalog.pg_extension_config_dump('ai.ai.semantic_catalog_sql_id_seq'::pg_catalog.regclass, '');
