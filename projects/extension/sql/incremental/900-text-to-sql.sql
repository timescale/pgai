...
, vectorizer_id pg_catalog.int4 not null default -1
);
perform pg_catalog.pg_extension_config_dump('ai.semantic_catalog_embedding'::pg_catalog.regclass, '');
perform pg_catalog.pg_extension_config_dump('ai.ai.semantic_catalog_embedding_id_seq'::pg_catalog.regclass, '');
