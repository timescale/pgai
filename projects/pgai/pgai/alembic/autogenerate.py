...
def enable_vectorizer_autogenerate():
    ...
    if not _autogen_registered:
        renderers.dispatch_for(CreateVectorizerOp)(render_create_vectorizer)
        renderers.dispatch_for(DropVectorizerOp)(render_drop_vectorizer)
        comparators.dispatch_for("schema")(compare_vectorizers)
        _autogen_registered = True
