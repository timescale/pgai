...
-------------------------------------------------------------------------------
-- 026-drop-loading-uri-old-signature.sql
do $outer_migration_block$ /*026-drop-loading-uri-old-signature.sql*/
declare
    _sql text;
    _migration record;
    _migration_name text = $migration_name$026-drop-loading-uri-old-signature.sql$migration_name$;
    _migration_body text =
$migration_body$
