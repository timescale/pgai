...
-------------------------------------------------------------------------------
-- 026-semantic-catalog.sql
do $outer_migration_block$ /*026-semantic-catalog.sql*/
declare
    _sql text;
    _migration record;
    _migration_name text = $migration_name$026-semantic-catalog.sql$migration_name$;
    _migration_body text =
$migration_body$
