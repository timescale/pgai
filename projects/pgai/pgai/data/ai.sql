...
-------------------------------------------------------------------------------
-- 019-add-worker-tracking-table.sql
do $outer_migration_block$ /*019-add-worker-tracking-table.sql*/
declare
    _sql text;
    _migration record;
    _migration_name text = $migration_name$019-add-worker-tracking-table.sql$migration_name$;
    _migration_body text =
$migration_body$
