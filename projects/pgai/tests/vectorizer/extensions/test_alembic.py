...
def create_migration_script(migrations_dir: Path) -> None:
    ...
    migration_content = load_template("migrations/001_create_test_table.py.template",
                                      revision_id="001",
                                      revises="",
...
def create_vectorizer_migration_scripts(migrations_dir: Path) -> None:
    ...
    blog_content = load_template("migrations/001_create_blog_table.py.template",
                                 revision_id="001",
                                 revises="",
                                 create_date="2024-03-19 10:00:00.000000",
                                 down_revision="None"
    ...
    vectorizer_content = load_template("migrations/002_create_vectorizer.py.template",
                                       revision_id="002",
                                       revises="001",
...
def test_vectorizer_migration(alembic_config: Config, initialized_engine: Engine):
    ...
    alembic.command.upgrade(alembic_config, "001")
    ...
    alembic.command.upgrade(alembic_config, "002")
    ...
    alembic.command.downgrade(alembic_config, "001")
